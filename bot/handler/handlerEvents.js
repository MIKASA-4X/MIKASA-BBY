...
function getRole(threadData, senderID) {
	...
	const vipUsers = global.vipUsers || [];  // VIP users
	return adminBot.includes(senderID) ? 2 : adminBox.includes(senderID) ? 1 : vipUsers.includes(senderID) ? 4 : 0;  // Role 4 for VIP users
}
